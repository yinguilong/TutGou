 ...
 *文件名：  HttpContextExtensions
 *版本号：  V1.0.0.0
 *创建人：  yinguilong
 *创建时间：7/8/2015 10:44:53 AM
 *描述：
 *
 *=====================================================================
 *修改标记
 *修改时间：7/8/2015 10:44:53 AM
 *修改人：  yinguilong
 *版本号： V1.0.0.0
 *描述：
 *
...
namespace OnlineNative.Infrastructure.Extensions
{
    public static class HttpContextExtensions
    {
        public static string GetServerHostHeader(this HttpRequestBase request)
        {
            ...
            var host = url.Split('.');
            //if (host.Length != 3) return string.Empty;
            //service.getshopbyhost(host);
            return host[0];
        }
