...
namespace OnlineNative.Repositories.EntityFramework
{
    public class EntityFrameworkRepositoryContext : IEntityFrameworkRepositoryContext
    {
        ...
        private readonly ThreadLocal<OnlineNativeDbContext> _localCtx = new ThreadLocal<OnlineNativeDbContext>(() => new OnlineNativeDbContext());
        public OnlineNativeDbContext DbContext
        {
